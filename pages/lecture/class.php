            ...
            <div class="wrapper mt-3">
                <div class="owl-carousel align-items-center">
                    <?php foreach ($result as $subject) : ?>
                        <a href="lecture-task.php?id=<?= $classID; ?>&subjectID=<?= $subject['id']; ?>&subject=<?= $subject['nama']; ?>" class="card-block">
                            <div class="card-subject px-3 py-4 d-flex align-items-center justify-content-center" style="background-color: #a7e0eb;">
