                    ...
                    <?php foreach ($task as $data) : ?>
                        <ul class="d-flex flex-column">
                            ...
                            <div class="mb-4 d-flex flex-column justify-content-between">
                                <form action="task-edit.php?id=<?= $id; ?>&subjectID=<?= $subjectID; ?>&subject=<?= $subject; ?>&taskName=<?= $taskName ?>" method="post" enctype="multipart/form-data">
                                ...
                                <form action="task-edit.php?id=<?= $id; ?>&subjectID=<?= $subjectID; ?>&subject=<?= $subject; ?>&taskName=<?= $taskName ?>" method="post" class="d-flex flex-column">
                                    <textarea class="mt-4 col-8 px-3 py-3" name="note" id="note" cols="30" rows="10"><?= $data['note']; ?></textarea>
